...
<h3>爐</h3>
<p>踩到爐按 <code>r</code> 休息:<b>回滿血和精力、冷卻歸零</b>,但<b>整層的敵人會全部復活</b>。</p>
<p>爐也是<b>兌換所</b>。你身上的是<b>燼</b>——殺東西掉的,<b>死了全部涼掉</b>。
在爐邊可以把燼<b>燒成灰</b>,灰帶得回灰燼之廳,死亡碰不到它。</p>
<p><b>越深的爐換得越多</b>:第一層大約一成,最底層九成。所以每走到一座爐,
你要決定的是<b>現在燒,還是再深一層再燒</b>——後者划算得多,前提是你活著走到。</p>

<h3>死了就是結束</h3>
<p>你會回到<b>灰燼之廳</b>,燼沒了、背包沒了、學過的樓層也沒了。
只有燒成灰的東西留下來,交給時間編織者。</p>

<h3>可以跑</h3>
<p>不是每隻敵人都追得上你。<b>殭屍很慢、獵犬很快</b>——繞過去是正當戰術,
而且在這個版本裡「繞過去」通常比「打贏」更值得:你要的是活著走到下一座爐。</p>
