...
export function buildHub() {
  ...
  // The way down, at the far end. Walking onto it is the only way a run
  // starts, so choosing a hero is something you do by standing next to them
  // rather than by ticking a box.
